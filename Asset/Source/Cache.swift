...
//    public class Cache {
//        public let cache: NSCache<ThumbnailIdentifier, UIImage>
//        public init() {
//            self.cache = NSCache<ThumbnailIdentifier, UIImage>()
//            let cc: NSMapTable<ThumbnailIdentifier, UIImage> = NSMapTable<ThumbnailIdentifier, UIImage>(keyOptions: NSPointerFunctions.Options.strongMemory, valueOptions: NSPointerFunctions.Options.weakMemory)
//            let scale = UIScreen.main.scale
//            let size = UIScreen.main.bounds.size
//            let pixelCount = Int(size.width * scale * size.height * scale + 0.5)
//            self.cache.totalCostLimit = pixelCount * 2
//
//
//        }
//    }
