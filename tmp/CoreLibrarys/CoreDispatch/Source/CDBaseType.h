...
struct _CDThread;
typedef struct _CDThread CDThread_s;

struct _CDThreadSyncWaiter;
typedef struct _CDThreadSyncWaiter CDThreadSyncWaiter_s;

struct _CDSyncContext;
typedef struct _CDSyncContext CDSyncContext_s;
...
struct _CDThreadSyncWaiter {
    ...
    CDSyncContext_s * _Nullable context;
};


typedef struct _CDThread {
#if __APPLE__
    ...
    CDThreadSyncWaiter_s * _Nullable waiter;
};

typedef struct _CDWorker {
    CDThreadInfo_s thread;
    CDThreadSyncWaiter_s waiter;
    void * _Nonnull loader;
    void * _Nonnull dealloctor;
...
typedef struct _CDThreadSpecific {
    CDThreadInfo_s thread;
    CDThreadSyncWaiter_s waiter;
    void * _Nonnull loader;
    void * _Nonnull dealloctor;
