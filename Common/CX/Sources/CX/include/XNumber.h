...
//正无穷
//CF_EXPORT
const XNumberRef kCFNumberPositiveInfinity;


//负无穷
//CF_EXPORT
const XNumberRef kCFNumberNegativeInfinity;


//非数
//CF_EXPORT
const XNumberRef kCFNumberNaN;
...
*/
XNumberRef XNumberCreate(CFAllocatorRef allocator, CFNumberType theType, const void *valuePtr);
...
XNumberType CFNumberGetType(XNumberRef _Nonnull number);
