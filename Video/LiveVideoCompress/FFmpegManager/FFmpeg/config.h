...
#define FFMPEG_CONFIGURATION "--enable-shared --disable-static --disable-ffplay --disable-ffprobe --enable-gpl --enable-libx264"
...
#define CONFIG_SCBinaryFileTypeImage_PNG_PIPE_DEMUXER 1
