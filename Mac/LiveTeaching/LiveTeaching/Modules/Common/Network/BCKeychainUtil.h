...
typedef enum {
	/** No error. */
	BCKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	BCKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	BCKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	BCKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	BCKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	BCKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	BCKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	BCKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	BCKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	BCKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	BCKeychainErrorFailedToDecode = errSecDecode
} BCKeychainErrorCode;

extern NSString *const kBCKeychainErrorDomain;

/** Account name. */
extern NSString *const kBCKeychainAccountKey;
 ...
 */
extern NSString *const kBCKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kBCKeychainClassKey;

/** Item description. */
extern NSString *const kBCKeychainDescriptionKey;

/** Item label. */
extern NSString *const kBCKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kBCKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kBCKeychainWhereKey;
...
/**
 ...
 BCKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface BCKeychainUtil : NSObject
...
/**
 ...
 See the `NSString` constants declared in BCKeychain.h for a list of keys that can be used when accessing the
