...
- (void)compressMp4WithInputPath:(NSString *)inputPath
    ...
    // ffmpeg语法，可根据需求自行更改
    // !#$ 为分割标记符，也可以使用空格代替
    NSString *commandStr = [NSString stringWithFormat:@"ffmpeg!#$-threads!#$2!#$-i!#$%@!#$-r!#$%ld!#$-crf!#$25!#$-b:a!#$24k!#$-b:v!#$%ldk!#$-c:v!#$libx264!#$-c:a!#$aac!#$-tune!#$ssim!#$-y!#$%@", inputPath, fps, videoBitRate, outputPath];
