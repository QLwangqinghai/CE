...
#define CEParamBufferItemSizeMax 242
...
static const CEParamType_e CEParamTypeRef = 10;

static const CEParamType_e CEParamTypeSInt64 = 11;
static const CEParamType_e CEParamTypeUInt64 = 12;
static const CEParamType_e CEParamTypeDouble = 13;

//static const CEParamType_e CEParamTypeBuffer = [13, 255];

static const uint8_t CEParamTypeSize[256] = {
    0, sizeof(_Bool), sizeof(int8_t), sizeof(uint8_t), sizeof(int16_t), sizeof(uint16_t), sizeof(int32_t), sizeof(uint32_t), sizeof(float), sizeof(CEPtr), sizeof(CERef), sizeof(int64_t), sizeof(uint64_t), sizeof(double), 1, 2,
