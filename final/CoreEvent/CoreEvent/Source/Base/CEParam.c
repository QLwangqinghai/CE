...
_Bool __CEParamAppendContentValue(CEParamRef _Nonnull paramRef, CType_e t, void * _Nonnull value) {
...
_Bool __CEParamGetContentValue(CEParamRef _Nonnull paramRef, uint32_t index, CType_e t, void * _Nonnull valuePtr) {
    CEParam_s * param = paramRef;
...
_Bool __CEParamGetItem(CEParamRef _Nonnull paramRef, uint32_t index, CType_e * _Nullable typePtr, size_t * _Nullable sizePtr, void * _Nonnull ptr, size_t maxSize) {
    CEParam_s * param = paramRef;
    if (index < param->base.count) {
        CType_e t = param->base.types[index];
        size_t size = CEParamTypeGetSize(t);
        if (maxSize < size) {
            return false;
        } else {
...
_Bool _CEStackParamAppendContentValue(CEStackParamRef _Nonnull stackParam, CType_e t, void * _Nonnull value) {
    return __CEParamAppendContentValue(stackParam, t, value);
}

_Bool _CEStackParamGetContentValue(CEStackParamRef _Nonnull stackParam, uint32_t index, CType_e t, void * _Nonnull valuePtr) {
    return __CEParamGetContentValue(stackParam, index, t, valuePtr);
}

_Bool _CEStackParamGetItem(CEStackParamRef _Nonnull stackParam, uint32_t index, CType_e * _Nullable type, size_t * _Nullable size, void * _Nonnull ptr, size_t maxSize) {
    return __CEParamGetItem(stackParam, index, type, size, ptr, maxSize);
}

_Bool _CEHeapParamAppendContentValue(CEHeapParamRef _Nonnull heapParam, CType_e t, void * _Nonnull value) {
    return __CEParamAppendContentValue(heapParam, t, value);
}

_Bool _CEHeapParamGetContentValue(CEHeapParamRef _Nonnull heapParam, uint32_t index, CType_e t, void * _Nonnull valuePtr) {
    return __CEParamGetContentValue(heapParam, index, t, valuePtr);
}

_Bool _CEHeapParamGetItem(CEHeapParamRef _Nonnull heapParam, uint32_t index, CType_e * _Nullable type, size_t * _Nullable size, void * _Nonnull ptr, size_t maxSize) {
...
_Bool CEParamGetItemType(CEParamRef _Nonnull param, uint32_t index, CType_e * _Nonnull itemType) {
    assert(param);
    assert(itemType);
    ...
    if (CETypeIsEqual(type, CETypeStackParam)) {
        ...
        if (index < stackParam->base.count) {
            CType_e t = stackParam->base.types[index];
            *itemType = t;
            return true;
        } else {
            return false;
        ...
        if (index < heapParam->base.count) {
            CType_e t = heapParam->base.types[index];
            *itemType = t;
            return true;
        } else {
            return false;
...
//    CETypeRef type = base->type;
//    assert(type);
//    CType_e itemType = CEParamTypeRef;
//    
//    if (CETypeIsEqual(type, CETypeStackParam)) {
//        CEParam_s * stackParam = param;
//        return _CEStackParamGetContentValue(stackParam, index, itemType, item);
...
_Bool CEParamGetItem(CEParamRef _Nonnull param, uint32_t index, CType_e * _Nullable typePtr, size_t * _Nullable sizePtr, void * _Nonnull ptr, size_t maxSize) {
    assert(param);
    assert(ptr);
...
_Bool CEParamAppendItem(CEParamRef _Nonnull param, CType_e t, void * _Nonnull itemPtr) {
    assert(param);
    assert(itemPtr);
