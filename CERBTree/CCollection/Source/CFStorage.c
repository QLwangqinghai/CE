...
//
//static inline int32_t roundToPage(int32_t num) {
...
//    uint32_t numBytes;	/* Number of actual bytes in this node and all its children */
...
//
//static inline CFStorageDoubleNodeReturn CFStorageDoubleNodeReturnMake(CFStorageNode *child, CFStorageNode *sibling) {
