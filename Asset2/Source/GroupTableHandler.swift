...
public class ThumbnailImageView1: UIStackView {
...
open class GroupTableHandler: NSObject, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    public typealias Provider = AssetProvider<ProviderContext, CachingImageManager, AssetContext>
    ...
    public private(set) var dataProvider: Provider? {
        didSet {
    ...
    public func update(dataProvider: Provider?) {
